...
def view_logistic(exp, input_dose):
    ...
    # Sampling
    n_sampling = 10000
    beta0_s = stats.skewnorm(jags.beta0_skew, jags.beta0_mu, jags.beta0_sigma).rvs(n_sampling, random_state=random_state)
    beta1_s = stats.skewnorm(jags.beta1_skew, jags.beta1_mu, jags.beta1_sigma).rvs(n_sampling, random_state=random_state)
    ...
    return render_template('view_cell_line.html', experiment=experiment, graph1Jason=graph1Jason, graph2Jason=graph2Jason,
                           graph3Jason=graph3Jason,graph4Jason=graph4Jason,graph5Jason=graph5Jason,form=form,form1=form1)